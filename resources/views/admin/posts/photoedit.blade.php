...
@push('styles')
    <!-- styles -->
	<!-- cropperjs -->
    <link rel="stylesheet" href="pluggins/cropper.min.css">
    <!-- cropper-compress -->
...
<!-- scripts -->
	<!-- cropper.js -->
	<script src="pluggins/cropper.min.js"></script>
	<!-- JIC.js -->
	<script src="pluggins/JIC.min.js"></script>
	<!-- browser-image-compression -->
	<script src="pluggins/browser-image-compression.js"></script>
	<!-- axios v0.19.0 -->
	<script src="pluggins/axios.min.js"></script>
	<!-- cropper-compress.js -->
